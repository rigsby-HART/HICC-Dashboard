...
def default_data(df, id, dynamic_text=''):
    filtered_df = df[df['ALT_GEO_CODE_EN'] == '5915002'].iloc[:, 5:]
    if (id == 'output_10a') or (id == 'output_10b'):
        new_header = [f'Household Suppression by age of Primary household maintainer -\
                   following BC HNR methodology (table {dynamic_text} of 2)'] * (len(filtered_df.columns))
    else:
        new_header = ['Changes in Headship rate of Primary Household Maintainer (PHM) by \
                      age between 2016 and 2021'] * (len(filtered_df.columns))

    filtered_df.columns = pd.MultiIndex.from_tuples(zip(new_header, filtered_df.columns))
    return filtered_df


output_2_for_dash = output_2[output_2['ALT_GEO_CODE_EN'] == '5915002'].iloc[:, 5:]
output_3_for_dash = output_3[output_3['ALT_GEO_CODE_EN'] == '5915002'].iloc[:, 5:]
output_4a_for_dash = output_4a[output_4a['ALT_GEO_CODE_EN'] == '5915002'].iloc[:, 5:]
output_4b_for_dash = output_4b[output_4b['ALT_GEO_CODE_EN'] == '5915002'].iloc[:, 5:]
output_5a_for_dash = output_5a[output_5a['ALT_GEO_CODE_EN'] == '5915002'].iloc[:, 5:]
output_5b_for_dash = output_5b[output_5b['ALT_GEO_CODE_EN'] == '5915002'].iloc[:, 5:]
output_6_for_dash = output_6[output_6['ALT_GEO_CODE_EN'] == '5915002'].iloc[:, 5:]
output_7_for_dash = output_7[output_7['ALT_GEO_CODE_EN'] == '5915002'].iloc[:, 5:]
output_8_for_dash = output_8[output_8['ALT_GEO_CODE_EN'] == '5915002'].iloc[:, 5:]

output_9_for_dash = default_data(output_10a, 'output_9')
output_10a_for_dash = default_data(output_10a, 'output_10a', 1)
output_10b_for_dash = default_data(output_10b, 'output_10b', 2)
...
layout = html.Div(children=[
    ...
    html.Div(id='page-content-to-print',
             children=[
                 ...
                 html.Div([
                     html.H4(children=html.Strong('Output 9: Changes in Headship Rate of PHM 2016-2021'),
                             id='visualization9'),
                     html.H6(
                         f'The following table shows Changes in Headship Rate of PHM 2016-2021',
                         style={'fontFamily': 'Open Sans, sans-serif'}
                     ),
                     ...
                     dash_table.DataTable(
                         ...
                         columns=[
                             ...
                             for col1, col2 in output_9_for_dash.columns],
                         data=[
                             {
                                 **{f"{x1}_{x2}": y for (x1, x2), y in data},
                             }
                             for (n, data) in [
                                 *enumerate([list(x.items()) for x in output_9_for_dash.T.to_dict().values()])
                             ]
                         ],
                 ...
                 # 2. HICC Section 3.3, data point 9 and 10. Plot 9  bar chart
                 html.Div([
                     html.H4(children=html.Strong(f'Graph 9: Headship Rates by age (2016 and 2021)'),
                             id='bar9'),
                     # Plot
                     html.Div([
                         html.H6(
                             f'The following graph shows change in headship rates by age',
                             style={'fontFamily': 'Open Sans, sans-serif'}
                         ),
                         ...
                         html.Div(id='graph_9-container')  # is this necessary?
                     ]),
                 ...
                 html.Div([
                     html.H4(children=html.Strong('Output 10a: Household suppression by age of PHM -1'),
                             id='visualization10a'),
                     html.H6(
                         f'The following table shows Household suppression by age of PHM - following BC HNR methodology (Table 1)',
                         style={'fontFamily': 'Open Sans, sans-serif'}
                     ),
                     ...
                     dash_table.DataTable(
                         ...
                         columns=[
                             {"name": [col1, col2], "id": f"{col1}_{col2}", "deletable": False, "selectable": False}
                             for col1, col2 in output_10a_for_dash.columns],
                         data=[
                             {
                                 **{f"{x1}_{x2}": y for (x1, x2), y in data},
                             }
                             for (n, data) in [
                                 *enumerate([list(x.items()) for x in output_10a_for_dash.T.to_dict().values()])
                             ]
                         ],
                         merge_duplicate_headers=True,
                         style_data={'whiteSpace': 'normal', 'overflow': 'hidden',
                 ...
                 html.Div([
                     html.H4(children=html.Strong('Output 10b: Household suppression by age of PHM -2'),
                             id='visualization10b'),
                     html.H6(
                         f'The following table shows Household suppression by age of PHM - following BC HNR methodology (Table 2)',
                         style={'fontFamily': 'Open Sans, sans-serif'}
                     ),
                     ...
                     dash_table.DataTable(
                         ...
                         columns=[
                             {"name": [col1, col2], "id": f"{col1}_{col2}", "deletable": False, "selectable": False}
                             for col1, col2 in output_10b_for_dash.columns],
                         data=[
                             {
                                 **{f"{x1}_{x2}": y for (x1, x2), y in data},
                             }
                             for (n, data) in [
                                 *enumerate([list(x.items()) for x in output_10b_for_dash.T.to_dict().values()])
                             ]
                         ],
                         merge_duplicate_headers=True,
                         style_data={'whiteSpace': 'normal', 'overflow': 'hidden',
                 ...
                 html.Div([
                     html.H4(children=html.Strong('Output 6: primary and secondary rental units in 2021'),
                             id='visualization6'),
                     html.H6(
                 ...
                 # Graph for output 6
                 html.Div([
                     html.H4(children=html.Strong(f'primary and secondary rental units in 2021.'),
                             id='graph-6'),
                     # Plot
                     html.Div([
                         html.H6(
                             f'The following of pie chart visualizes the relative share of Primary and Secondary Rental units',
                             style={'fontFamily': 'Open Sans, sans-serif'}
                         ),
                         ...
                         html.Div(id='graph_6-container')  # is this necessary?
                     ]),

                 ], className='pg2-pie-6-lgeo'
                 ),
                 ...
                 html.Div([
                     html.H4(children=html.Strong('Output 2a: Average rents '),
                             id='visualization2a'),  # why did he reuse id='visualization3' for every graph??
                     html.H6(
                     ...
                     dash_table.DataTable(
                         ...
                         columns=[{"name": col, "id": col, "deletable": False, "selectable": False} for col in
                                  output_2_for_dash.columns],
                         data=output_2_for_dash.to_dict('records'),
                         # editable=False,
                         # sort_action="native",
                         # sort_mode="multi",
                 ...
                 html.Div([
                     html.H4(children=html.Strong('Output 2b: Change in Average rents '),
                             id='visualization2b'),
                     html.H6(
                 ...
                 # 6. HICC Section 5.4, data point 2. Plot 2b  bar chart
                 html.Div([
                     html.H4(children=html.Strong(f'Graph 2b: The change in average rents between 2016 and 2023.'),
                             id='bar2b'),
                     # Plot
                     html.Div([
                         html.H6(
                             f'The following graph shows change in average monthly rent',
                             style={'fontFamily': 'Open Sans, sans-serif'}
                         ),
                 ...
                 ], className='pg2-bar2b-1-lgeo'),

                 # output 3 tables
                 html.Div([
                 html.H4(children=html.Strong('Output 3: The change in vacancy rates between 2016 and 2023 '),
                         id='visualization3a'),
                 html.H6(
                 ...
                 #output 3- 2 bar charts graph_3a and graph_3b
                 html.Div([
                     html.H4(children=html.Strong(f'The change in vacancy rates between 2016 and 2023.'),
                             id='bar3'),
                     # Plot
                     html.Div([
                         html.H6(
                             f'The following graph shows change in vacancy rates',
                             style={'fontFamily': 'Open Sans, sans-serif'}
                         ),
                 ...
                 ], className='pg2-bar3-lgeo'
                 ),

                 # HICC Section 5.6, data point 5.
                 html.Div([
                 html.H4(children=html.Strong('Section 5.6, data point 5: How have trends in core housing need changed over time between both tenant and owner-occupied households?'),
                         id='visualization5'),
                 html.H6(
                     f'The following tables show the change in core housing need over time (2016 to 2021) between both tenant/renter and owner-occupied households.'
                ...
                html.H6(
                     f'The following table shows the rate of core housing need between both tenant/renter and owner-occupied households.'
                     f'-	Data source: <add link>.',
                     style={'fontFamily': 'Open Sans, sans-serif'}
                 ),
                 ...
                 # output 5 bar charts
                 html.Div([
                     html.H4(children=html.Strong(f'change in core housing need over time (2016 to 2021) between both tenant/renter and owner-occupied households'),
                             id='bar5'),
                     # Plot
                     html.Div([
                         html.H6(
                             f'The following graph shows change in core housing need over time ',
                             style={'fontFamily': 'Open Sans, sans-serif'}
                         ),
                 ...
                 html.Div([
                     html.H4(children=html.Strong('Output 7: Number of housing units subsidized vs not subsidized'),
                             id='visualization7'),  # why did he reuse id='visualization3' for every graph??
                     html.H6(
                         f'The following table shows Number of housing units subsidized vs not subsidized',
                         style={'fontFamily': 'Open Sans, sans-serif'}
                     ),
                     ...
                     dash_table.DataTable(
                         id='output_7',
                         columns=[{"name": col, "id": col, "deletable": False, "selectable": False} for col in
                                  output_7_for_dash.columns],
                         data=output_7_for_dash.to_dict('records'),
                         merge_duplicate_headers=True,
                         style_data={'whiteSpace': 'normal', 'overflow': 'hidden',
                                     'textOverflow': 'ellipsis'},
                         style_cell={'font-family': 'Bahnschrift',
                 ...
                 # 6. HICC Section 5.7.1, data point 2. Plot 7 pie chart
                 html.Div([
                     html.H4(children=html.Strong(f'Graph 7: Share of subsidized vs not subzidized housing units'),
                             id='pie7'),
                     # Plot
                     html.Div([
                         html.H6(
                             f'The following pie shows Share of subsidized vs not subzidized housing units',
                             style={'fontFamily': 'Open Sans, sans-serif'}
                         ),
                         dcc.Graph(id='pie_7',
                                   figure=fig1,
                         ...
                         html.Div(id='pie_7-container')  # is this necessary?
                     ]),

                 ], className='pg2-pie7-lgeo'),

                 # 10. HICC Section 5.7.1, data point 8. Output 8
                 html.Div([
                     html.H4(children=html.Strong('Output 8: Number of housing below market rent in private market'),
                             id='visualization8'),  # why did he reuse id='visualization3' for every graph??
                     html.H6(
                         f'The following table shows Number of housing below market rent in private market',
                         style={'fontFamily': 'Open Sans, sans-serif'}
                     ),
                     ...
                     dash_table.DataTable(
                         id='output_8',
                         columns=[{"name": col, "id": col, "deletable": False, "selectable": False} for col in
                                  output_8_for_dash.columns],
                         data=output_8_for_dash.to_dict('records'),
                         merge_duplicate_headers=True,
                         style_data={'whiteSpace': 'normal', 'overflow': 'hidden',
                                     'textOverflow': 'ellipsis'},
                         style_cell={'font-family': 'Bahnschrift',
                 ...
                 html.Div([
                     html.H4(children=html.Strong('Output 4: Housing starts by structural type and tenure'),
                             id='visualization4'),
                     html.H6(
                 ...
                 html.Div([
                     html.H4(children=html.Strong(f'Housing starts by structural type'),
                             id='bar4a'),
                     # Plot
                     html.Div([
                         html.H6(
                 ...
                 html.Div([
                     html.H4(children=html.Strong(f'Housing starts by Tenure'),
                             id='bar4b'),
                     # Plot
                     html.Div([
                         html.H6(
                             f'The following graph shows Housing starts by Tenure',
                             style={'fontFamily': 'Open Sans, sans-serif'}
                         ),
...
def update_geo_figure_3ab(geo, geo_c, scale, refresh):
    ...
    # Generating plot
    fig1 = go.Figure()
    y_vals1 = table_VacancyRate.values.flatten().tolist()[1:]
...
def update_output_4b(geo, geo_c, scale, selected_columns):
    ...
    table = number_formatting(table, ['2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023'], 0)
...
def update_geo_figure_4a(geo, geo_c, scale, refresh):
    ...
    # Generating plot
    fig1 = go.Figure()
    y_vals1 = table[table['Metric']=='Apartment'].values.flatten().tolist()[1:]
    y_vals2 = table[table['Metric']=='Row'].values.flatten().tolist()[1:]
    y_vals3 = table[table['Metric']=='Semi-detached'].values.flatten().tolist()[1:]
    y_vals4 = table[table['Metric']=='Single-detached'].values.flatten().tolist()[1:]
...
def update_geo_figure_4b(geo, geo_c, scale, refresh):
    ...
    # Generating plot
    fig1 = go.Figure()
    y_vals1 = table[table['Metric']=='Owner'].values.flatten().tolist()[1:]
    y_vals2 = table[table['Metric']=='Rental'].values.flatten().tolist()[1:]
    y_vals3 = table[table['Metric']=='Condo'].values.flatten().tolist()[1:]
    y_vals4 = table[table['Metric']=='Co-op'].values.flatten().tolist()[1:]
    y_vals5 = table[table['Metric'] == 'N/A'].values.flatten().tolist()[1:]
...
def update_geo_figure_9(geo, geo_c, scale, refresh):
    ...
    fig1.update_layout(
        ...
        barmode='group',
        plot_bgcolor='#F8F9F9',
        title=f'Headship rates by age {geo}',
    ...
    fig2.update_yaxes(
        ...
        # range = [min(table['']),100]
        # fixedrange = True,
        title='Changes to headship rates by age (2016 & 2021)'
    )
